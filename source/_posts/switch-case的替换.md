...
根据[Advantage of switch over if-else statement](https://stackoverflow.com/questions/97987/advantage-of-switch-over-if-else-statement)了解到，通常情况下编译器会为switch-case建立二叉决策树或者建立跳转表。
